    ...
    <div class="card overflow-hidden">
        ...
        <div class="card-header bg-transparent">
            <div class="d-flex justify-content-between">
                ...
                <button class="btn btn-sm btn-primary text-white" wire:click.prevent="add">Add Customer</button>
            </div>
        </div>
        <!-- /card header -->
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered mb-0">
                    ...
                    <tr>
                        ...
                        <th class="text-uppercase">Passport/EID</th>
...
{{--                                </button>--}}
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="model-8">Add Customer</h3>
                ...
                <form wire:submit.prevent="submit">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="passport" class="col-form-label">Passport/EID</label>
                            <input class="form-control" id="passport" wire:model.defer="passport" type="text" placeholder="Enter Passport/EID Here">
                            @error('passport')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
    ...
    <div wire:ignore.self class="modal fade" id="update-modal" role="dialog" aria-labelledby="model-8"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="model-8">Update Customer</h3>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
