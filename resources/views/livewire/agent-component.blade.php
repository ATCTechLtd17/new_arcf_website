    ...
    <div class="card overflow-hidden">
        ...
        <div class="card-header bg-transparent">
            <div class="d-flex justify-content-between">
                ...
                <button class="btn btn-sm btn-primary text-white" wire:click.prevent="addAgent">Add Agent</button>
            </div>
        </div>
        <!-- /card header -->
                ...
                <table class="table table-bordered mb-0">
                    ...
                    @forelse($agents as $agent)
                        <tr>
                            ...
                            <td>{{ $agent->type->getLabel() }}</td>
                            <td>{{ $agent->name }}</td>
                            <td>{{ $agent->phone }}</td>
                            <td>{{ $agent->company_name }}</td>
                            <td>{{ $agent->address }}</td>
                            <td>
                                <button type="button" wire:click="editAgent({{ $agent->id }})"
...
{{--                                </button>--}}
    ...
    {{-- Create Modal --}}
    <div wire:ignore.self class="modal fade" id="add-agent-modal" role="dialog" aria-labelledby="model-8"
         aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="model-8">Add Agent</h3>
    ...
    {{-- Edit Modal --}}
    <div wire:ignore.self class="modal fade" id="update-agent-modal" role="dialog" aria-labelledby="model-8"
         aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="model-8">Update Agent</h3>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
    ...
    {{-- Delete Modal --}}
    <div class="modal fade" id="delete-agent-modal" tabindex="-1" role="dialog" aria-labelledby="model-3"
