    ...
    <div class="card overflow-hidden">
        ...
        <div class="card-header bg-transparent">
            <div class="d-flex justify-content-between">
                ...
                <button class="btn btn-sm btn-primary text-white" wire:click.prevent="add">Add</button>
            </div>
        </div>
        <!-- /card header -->
                ...
                <table class="table table-bordered mb-0">
                    ...
                    @forelse($chartOfAccounts as $chartOfAccount)
                        <tr>
                            ...
                            <td>{{ $chartOfAccount->type->getLabel() }}</td>
                            <td>{{ $chartOfAccount->name }}</td>
                            <td>
                                <button type="button" wire:click="edit({{ $chartOfAccount->id }})"
                                        class="btn btn-sm btn-warning">Edit</button>
{{--                                <button type="button" wire:click="delete({{ $chartOfAccount->id }})"--}}
...
{{--                                </button>--}}
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="model-8">Add Chart of Account</h3>
    ...
    <div wire:ignore.self class="modal fade" id="update-modal" role="dialog" aria-labelledby="model-8"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="model-8">Update Chart of Account</h3>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
