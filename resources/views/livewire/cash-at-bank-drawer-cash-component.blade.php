    ...
    <div class="card overflow-hidden">
        ...
        <div class="card-header bg-transparent">
            <div class="d-flex justify-content-between">
                <h3 class="card-title">Cash at Bank to Drawer Cash</h3>
            </div>
        </div>
        <!-- /card header -->
        ...
        <div class="card-body pt-0" id="printReport">
            <div class="d-print-block d-none" style="top: 0; right: 0; left: 0">
                @component('print-page-header', ['title' => "Cash at Bank to Drawer Cash"])@endcomponent
            </div>
            <!-- Tables -->
                    ...
                    @forelse($banks as $bank)
                        ...
                        <tr>
                            ...
                            <td class="d-print-none">
                                <button type="button" wire:click="add({{ $bank->id }})" class="btn btn-sm btn-warning">Transfer to Drawer Cash</button>
                            </td>
                        </tr>
                    @empty
                        <tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title" id="model-8">Cash at Bank to Drawer Cash</h3>
